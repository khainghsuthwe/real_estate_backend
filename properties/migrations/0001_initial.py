# Generated by Django 4.2.21 on 2025-06-06 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('user', 'User'), ('agent', 'Agent'), ('admin', 'Admin')], default='user', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing_type', models.CharField(choices=[('sell', 'Sell'), ('rent', 'Rent')], default='sell', max_length=10)),
                ...
                ('feature_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True)),
